...
void main() {
  ...
  print('Generating MVC folder structure for Flutter with BLoC...');
  ...
  createDirectory('$baseDir/controllers/auth');
  createDirectory('$baseDir/controllers/product');
  ...
  createFileWithContent(
      '$baseDir/controllers/auth/auth_bloc.dart', authBlocSample(projectName));
  createFileWithContent('$baseDir/controllers/product/product_bloc.dart',
  ...
  print('MVC folder structure with BLoC generated successfully!');
}
...
import 'package:$projectName/controllers/auth/auth_bloc.dart';
...
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:$projectName/controllers/product/product_bloc.dart';
