...
void main() {
  ...
  print('Generating MVVM folder structure for Flutter with Provider...');
  ...
  createDirectory('$baseDir/viewmodels');
  ...
  createFileWithContent('$baseDir/viewmodels/auth_viewmodel.dart',
      authViewModelSample(projectName));
  createFileWithContent('$baseDir/viewmodels/product_viewmodel.dart',
      productViewModelSample(projectName));
  ...
  print('MVVM folder structure with Provider generated successfully!');
}
...
// Sample content for auth_viewmodel.dart with Provider
String authViewModelSample(String projectName) {
  return '''
...
// Sample content for product_viewmodel.dart with Provider
String productViewModelSample(String projectName) {
  return '''
import 'package:flutter/foundation.dart';
...
import 'package:$projectName/viewmodels/auth_viewmodel.dart';
...
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:$projectName/viewmodels/product_viewmodel.dart';
